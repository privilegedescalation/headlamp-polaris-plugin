...
# Inside pod, test DNS and HTTP (Service DNS name: <service>.<namespace>.<cluster-domain>)
nslookup polaris-dashboard.polaris
curl -v http://polaris-dashboard.polaris/results.json
```
